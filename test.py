...
# Constants
MODEL_PATH = r'C:\Users\Harminder\PycharmProjects\Capstone-Project\runs\detect\best2.pt' ### **CHANGE** (CHANGE THE PATH TO WHERE THE MODEL IS) ###
...
# Main function
def main():
    input_image_path = 'eee.jpg' ### **CHANGE** (CHANGE THE NAME OF THE "input_image" VARIABLE) ###
